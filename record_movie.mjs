...
// 映像尺: OP8s + 前半60s + 後半(100作×6s+バナー12s+タメ62s+リキャップ7.6s) + 表彰台12s ≒ 762s (mult=1)
const MODES = {
  standard:   { speed: 1,   durationSec: 775, fps: 30, everyNth: 2, out: 'movie_standard.mp4',       label: '標準/30fps' },
  fast:       { speed: 0.6, durationSec: 470, fps: 30, everyNth: 2, out: 'movie_fast.mp4',           label: '速い/30fps' },
  standard60: { speed: 1,   durationSec: 775, fps: 60, everyNth: 1, out: 'movie_standard_60fps.mp4', label: '標準/60fps' },
  fast60:     { speed: 0.6, durationSec: 470, fps: 60, everyNth: 1, out: 'movie_fast_60fps.mp4',     label: '速い/60fps' },
};
